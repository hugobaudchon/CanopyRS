...
pip install -e .
pip install --no-build-isolation git+https://github.com/facebookresearch/detectron2.git@70f4543
pip install --no-build-isolation  git+https://github.com/IDEA-Research/detrex.git
```
